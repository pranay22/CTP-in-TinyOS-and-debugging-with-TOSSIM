...
module MyMonitorNetworkC {
  ...
  uses interface Send as TestSend;
  /*****************************************************/
  ...
  uses interface Receive as TestReceive;
  /*****************************************************/
...
implementation {
  ...
  /*****************************************************/
  //Task 2.1 add your code here. 
  //define the interval at which monitoring packet are
  //generated
  /*****************************************************/
  ...
  event void RadioControl.startDone(error_t err) {
	...
	call RootControl.setRoot();
      ...
      seqno = 0;
        call TestTimer.startOneShot(call Random.rand16() & 0x1ff);
    }
  }
  ...
  void generateAndSendMonitorMessage(){
  /*****************************************************/
  //Task 2.3 add your code here
  /*****************************************************/

  }

  void forwardMonitorMessage(message_t* msg, void* payload, uint8_t len){
  /*****************************************************/
  //Task 4.2 add your code here
  /*****************************************************/
   
  }

  void outputMonitorMessage(message_t* msg, void* payload, uint8_t len){
  /*****************************************************/
  //Task 4.3 add your code here
  /*****************************************************/
  }

  void sendMessage() {
    TestNetworkMsg* msg = (TestNetworkMsg*)call TestSend.getPayload(&packet, sizeof(TestNetworkMsg));
    uint16_t metric;
    am_addr_t parent;
    ...
    if (call TestSend.send(&packet, sizeof(TestNetworkMsg)) != SUCCESS) {
      failedSend();
      call Leds.led0On();
  ...
  event void TestTimer.fired() {
    ...
    call TestTimer.startOneShot(nextInt);
    if (!sendBusy)
	sendMessage();
  }
  ...
  event void TestSend.sendDone(message_t* m, error_t err) {
    if (err != SUCCESS) {
	//      call Leds.led0On();
    }
    sendBusy = FALSE;
  ...
  /*****************************************************/
  //Task 2.4 add your code here
  /*****************************************************/
  
  event void DisseminationPeriod.changed() {
    const uint16_t* newVal = call DisseminationPeriod.get();
    call TestTimer.stop();
    call TestTimer.startPeriodic(*newVal);
  }

  event message_t* 
  TestReceive.receive(message_t* msg, void* payload, uint8_t len){
    dbg("TestNetworkC", "Received packet at %s from node %hhu.\n", sim_time_string(), call CtpPacket.getOrigin(msg));
  ...
  /*****************************************************/
  //Task 3.3 & Task 4.1 add your code here
  /*****************************************************/
